...
STEP4="$PYEX $MCBIN/step4.py --xts -i 7.4 -n 1"
...
STEPB="/data/home/granepura/5-Kinases/Kinases_MCCE/scripts_Kinases_MCCE/make_holo_apo_step2_out.py"  # Central StepB: see scripts_Kinases_MCCE/
