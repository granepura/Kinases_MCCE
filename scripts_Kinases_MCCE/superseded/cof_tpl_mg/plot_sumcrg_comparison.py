...
# === Configuration ===
dir1 = "/home/granepura/5-kinases/cof_tpl_mg/run_prot2"
dir2 = "/home/granepura/5-kinases/cof_tpl_mg/run_kin"
lst_file = "/home/granepura/5-kinases/cof_tpl_mg/pdb_inhibitor.lst"
plot_dir = "plots_kin_vs_prot2"
log_file = "plot_sumcrg_comparison.log"
...
def parse_sum_crg(filepath):
    """Parse sum_crg.out into {residue: charge}, skipping headers and summary lines."""
    charges = {}
...
for idx, (pdb, (inhibitor, icode)) in enumerate(sorted(inhibitor_codes.items()), 1):
    file1 = os.path.join(dir1, pdb, "sum_crg.out")
    file2 = os.path.join(dir2, pdb, "sum_crg.out")
