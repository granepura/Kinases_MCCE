...
```
b0bd5af5096f42443e47d6a800cf1e4ca31eb8676e983f522284529bf20053f0  /data/home/granepura/5-Kinases/Kinases_MCCE/Trial01/0-prepare_run_apo.py
f84e4ee956556962d3871dcc75fc4c2801fb49a5eff24c488c3529f8efec4211  /data/home/granepura/5-Kinases/Kinases_MCCE/Trial01/1-run_xts_corr.py
...
2. Seed apo from holo (needs only holo's split step2 variants, so it can run as
   soon as holo's steps 1-2 finish -- no need to wait for holo's step3/4).  Copies each
