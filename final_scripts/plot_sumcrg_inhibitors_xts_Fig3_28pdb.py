...
FILTERED to only the 28 PDB entries (27 unique) present in the excel table.
...
Updated: Jun 6, 2026 - Filtered to 28 PDB entries from excel
"""
...
plot_dir = "plots_inhibitors_kin_vs_cof2_xts_28pdb"
log_file = "plot_sumcrg_inhibitors_xts_28pdb.log"
...
print_log("="*80)
print_log(f"LOADED {len(inhibitor_map)} PDB ENTRIES from {lst_file} (filtered to {len(INCLUDE_PDBS)} excel PDBs)")
print_log("="*80)
